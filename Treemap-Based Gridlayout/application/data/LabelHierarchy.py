...
class LabelHierarchy(object):
    def __init__(self):
        ...
        # self.root_path = '../DetectionVA/backend/datasets/'
    ...
    def load(self, dataset='imagenet'):
        ...
        if dataset == "infographic":
            ...
            self.features = np.load(os.path.join(path, 'test2_features.npy'))
            self.labels = np.load(os.path.join(path, 'test2_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'test2_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'test2.json'))
        elif dataset == "new_dataset":
            self.features = np.load(os.path.join(path, 'new_dataset_features.npy'))
            self.labels = np.load(os.path.join(path, 'new_dataset_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'new_dataset_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'new_dataset.json'))
        elif dataset == "multiple_1000":
            self.features = np.load(os.path.join(path, 'multiple_1000_features.npy'))
            self.labels = np.load(os.path.join(path, 'multiple_1000_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'multiple_1000_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'multiple_1000.json'))
        elif dataset == "multiple_10000":
            self.features = np.load(os.path.join(path, 'multiple_10000_features.npy'))
            self.labels = np.load(os.path.join(path, 'multiple_10000_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'multiple_10000_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'multiple_10000.json'))
        elif dataset == "mixed_10000":
            self.features = np.load(os.path.join(path, 'mixed_10000_features.npy'))
            self.labels = np.load(os.path.join(path, 'mixed_10000_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'mixed_10000_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'mixed_10000.json'))
        elif dataset == "mixed_10000_dreamsim":
            self.features = np.load(os.path.join(path, 'mixed_10000_features.npy'))
            self.labels = np.load(os.path.join(path, 'mixed_10000_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'mixed_10000_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'mixed_10000.json'))
        elif dataset == "mixed_10000_shuffle":
            self.features = np.load(os.path.join(path, 'mixed_10000_shuffle_features.npy'))
            self.labels = np.load(os.path.join(path, 'mixed_10000_shuffle_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'mixed_10000_shuffle_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'mixed_10000_shuffle.json'))
        elif dataset == "mixed_10000_case2(chart=69.0)":
            self.features = np.load(os.path.join(path, 'mixed_10000_case2(chart=69.0)_features.npy'))
            self.labels = np.load(os.path.join(path, 'mixed_10000_case2(chart=69.0)_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'mixed_10000_case2(chart=69.0)_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'mixed_10000_case2(chart=69.0).json'))
        elif dataset == "mixed_10000_done(chart=69.0)":
            self.features = np.load(os.path.join(path, 'mixed_10000_done(chart=69.0)_features.npy'))
            self.labels = np.load(os.path.join(path, 'mixed_10000_done(chart=69.0)_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'mixed_10000_done(chart=69.0)_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'mixed_10000_done(chart=69.0).json'))
        elif dataset == "mixed_10000_fixed":
            self.features = np.load(os.path.join(path, 'mixed_10000_fixed_features.npy'))
            self.labels = np.load(os.path.join(path, 'mixed_10000_fixed_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'mixed_10000_fixed_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'mixed_10000_fixed.json'))
        elif dataset == "mixed_10000_fixed_case2(chart=69.0)":
            self.features = np.load(os.path.join(path, 'mixed_10000_fixed_case2(chart=69.0)_features.npy'))
            self.labels = np.load(os.path.join(path, 'mixed_10000_fixed_case2(chart=69.0)_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'mixed_10000_fixed_case2(chart=69.0)_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'mixed_10000_fixed_case2(chart=69.0).json'))
        elif dataset == "mixed_10000_fixed_done(chart=69.0)":
            self.features = np.load(os.path.join(path, 'mixed_10000_fixed_done(chart=69.0)_features.npy'))
            self.labels = np.load(os.path.join(path, 'mixed_10000_fixed_done(chart=69.0)_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'mixed_10000_fixed_done(chart=69.0)_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'mixed_10000_fixed_done(chart=69.0).json'))
        elif dataset == "lizhen_QA":
            self.features = np.load(os.path.join(path, 'lizhen_QA_features.npy'))
            self.labels = np.load(os.path.join(path, 'lizhen_QA_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'lizhen_QA_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'lizhen_QA.json'))
        elif dataset == "ChartQAPro":
            self.features = np.load(os.path.join(path, 'ChartQAPro_features.npy'))
            self.labels = np.load(os.path.join(path, 'ChartQAPro_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'ChartQAPro_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'ChartQAPro.json'))
        elif dataset == "ChartQAPro_text":
            self.features = np.load(os.path.join(path, 'ChartQAPro_text_features.npy'))
            self.labels = np.load(os.path.join(path, 'ChartQAPro_text_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'ChartQAPro_text_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'ChartQAPro_text.json'))
        elif dataset == "ChartQAPro_text2":
            self.features = np.load(os.path.join(path, 'ChartQAPro_text2_features.npy'))
            self.labels = np.load(os.path.join(path, 'ChartQAPro_text2_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'ChartQAPro_text2_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'ChartQAPro_text2.json'))
        elif dataset == "ChartQAPro_QA":
            self.features = np.load(os.path.join(path, 'ChartQAPro_QA_features.npy'))
            self.labels = np.load(os.path.join(path, 'ChartQAPro_QA_labels.npy'))
            self.gt_labels = np.load(os.path.join(path, 'ChartQAPro_QA_labels.npy'))
            self.label_hierarchy = self._load_json(os.path.join(path, 'ChartQAPro_QA.json'))
            ...
            self.confs_hierarchy = {'id_map': self.full_confs_hierarchy['id_map'],
                                    'confs': self.full_confs_hierarchy['confs'][self.load_samples]}
