...
export default {
    ...
    data: function() {
        return {
            ...
            can_apply: false,
            categories: [  // TO FILL
                { text: "HRO", name: "visual_element", color: "rgb(134, 204, 70)", thres: 0.3 },
                { text: "Text", name: "text", color: "rgb(169, 129, 188)", thres: 0.3 },
                { text: "Chart", name: "data_element", color: "rgb(40, 176, 231)", thres: 0.3 },
            ],
            categories2: [  // TO FILL
                { text: "HRO", name: "visual_element", color: 'rgb(175, 237, 12)', thres: 0.3 },
                { text: "Text", name: "text", color: 'rgb(199, 133, 252)', thres: 0.3 },
                { text: "Chart", name: "data_element", color: 'rgb(100, 220, 255)', thres: 0.3 },
            ],
        };
    },
    mounted() {
